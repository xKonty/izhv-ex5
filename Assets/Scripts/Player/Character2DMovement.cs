...
public class Character2DMovement : MonoBehaviour
{
    ...
    void AnimateCharacter()
    {
		...
		bool mHeadingRight_prev = mHeadingRight;
		 if(mInput.move.x == 1 && mHeadingRight_prev == true){
			mHeadingRight = true;
		 }else if (mInput.move.x == 1 && mHeadingRight_prev == false){
			mHeadingRight = true;
			changedDirection = true;
		 }else if(mInput.move.x == -1 && mHeadingRight_prev == true){
			mHeadingRight = false;
			changedDirection = true;
		 } else if(mInput.move.x == -1 && mHeadingRight_prev == false){
			mHeadingRight = false;
